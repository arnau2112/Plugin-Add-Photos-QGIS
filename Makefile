...
SOURCES = \
	__init__.py \
	add_photo.py add_photo_dialog.py

PLUGINNAME = add_photo

PY_FILES = \
	__init__.py \
	add_photo.py add_photo_dialog.py

UI_FILES = add_photo_dialog_base.ui
...
QGISDIR=C:\Users\becari.a.sola\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
